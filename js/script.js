    ...
    function addCity() {
        ...
        if (city.length < 3) {
            Toastify({
                ...
                text: "Pleace type your city name correctly.",
...
function findWord() {
    ...
    if (!word) {
       ...
       Toastify({
            ...
            text: "Pleace type a word for find.",
...
function replaceWord() {
    ...
    if (!word) {
        Toastify({
            ...
            text: "Pleace type a word for replacing.",
    ...
    if (!replaceWith) {
        ...
        Toastify({
            ...
            text: "Pleace type a word to replace it with.",
